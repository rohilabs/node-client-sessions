...
Session.prototype = {
  ...
  updateCookie: function() {
    if (this.isDirty()) {
      ...
      try {
        this.cookies.set(this.opts.cookieName, this.box(), Object.assign({}, this.opts.cookie, this.cookieOpts));
      } catch (x) {
...
function clientSessionFactory(opts) {
  ...
  return function clientSession(req, res, next) {
    ...
    Object.defineProperty(req, `${propertyName}CookieOpts`, {
      get: function getCookieOpts() {
        return rawSession.cookieOpts;
      },
      set: function setCookieOpts(value) {
        rawSession.cookieOpts = value;
      }
    });
